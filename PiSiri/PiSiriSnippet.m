...
{
	// NSLog(@"[PiSiriSnippet initWithProperties:'%@']", props);

	if ((self = [super init]))
	{
		if (![[NSBundle bundleForClass:[self class]] loadNibNamed:@"PiSiriNib" owner:self options:nil])
		{
